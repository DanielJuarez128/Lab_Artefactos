...
void loop() {
  ...
  if (valorTouch < UMBRAL_TOUCH | valorTouch2 < UMBRAL_TOUCH) {
    display.setCursor(15, 28);
    if (valorTouch < UMBRAL_TOUCH && valorTouch2 < UMBRAL_TOUCH) {
      display.setCursor(8, 28);
      display.println("Toque en ambos pines");
    } else if (valorTouch < UMBRAL_TOUCH && valorTouch2 > UMBRAL_TOUCH) {
      display.print("Toque en pin ");
      display.print(TOUCH_PIN);
    } else {
      display.print("Toque en pin ");
      display.print(TOUCH_PIN_2);
    }
